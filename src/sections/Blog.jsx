...
//                   <motion.div layoutId={`image-${blog.title}`}>
//                     <CustomShapeImage
//                       src={blog.image}
//                       width={350}
//                       height={300}
...
//                   <motion.h1
//                     layoutId={`title-${blog.title}`}
//                     className="text-xl font-bold line-clamp-1 text-start"
//                   >
//                     {blog.title}
//                   </motion.h1>
//                   <motion.p
//                     layoutId={`description-${blog.description}`}
//                     className="text-gray-600 text-sm line-clamp-2  text-start"
//                   >
//                     {blog.description}
//                   </motion.p>
//                 </div>
